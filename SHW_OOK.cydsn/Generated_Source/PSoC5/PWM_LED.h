...
#define PWM_LED_UseOneCompareMode              (1u)
#define PWM_LED_MinimumKillTime                (1u)
#define PWM_LED_EnableMode                     (1u)
...
**************************************/
#define PWM_LED_INIT_PERIOD_VALUE          (119u)
#define PWM_LED_INIT_COMPARE_VALUE1        (0u)
#define PWM_LED_INIT_COMPARE_VALUE2        (63u)
...
#define PWM_LED_DEFAULT_COMPARE2_MODE      (uint8)((uint8)1u <<  PWM_LED_CTRL_CMPMODE2_SHIFT)
#define PWM_LED_DEFAULT_COMPARE1_MODE      (uint8)((uint8)1u <<  PWM_LED_CTRL_CMPMODE1_SHIFT)
