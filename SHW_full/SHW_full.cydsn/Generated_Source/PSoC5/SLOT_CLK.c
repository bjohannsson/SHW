...
void SLOT_CLK_Start(void) 
{
    ...
    SLOT_CLK_CLKEN |= SLOT_CLK_CLKEN_MASK;
	SLOT_CLK_CLKSTBY |= SLOT_CLK_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: SLOT_CLK_Stop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SLOT_CLK_StopBlock
********************************************************************************
*
* Summary:
...
void SLOT_CLK_StopBlock(void) 
{
    if ((SLOT_CLK_CLKEN & SLOT_CLK_CLKEN_MASK) != 0u)
    {
        ...
        oldDivider = CY_GET_REG16(SLOT_CLK_DIV_PTR);
