...
// EdgeRising(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=EdgeRising, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EdgeRising_7, CY_INSTANCE_SHORT_NAME=EdgeRising_7, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=EdgeRising_7, )
module EdgeRising_8 (
    d,
    clk,
    det);
...
// EdgeRising(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=EdgeRising, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EdgeRising_6, CY_INSTANCE_SHORT_NAME=EdgeRising_6, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=EdgeRising_6, )
module EdgeRising_16 (
    d,
    clk,
    det);
    input       d;
...
// EdgeRising(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=EdgeRising, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EdgeRising_5, CY_INSTANCE_SHORT_NAME=EdgeRising_5, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=EdgeRising_5, )
module EdgeRising_17 (
    d,
    clk,
    det);
    input       d;
...
// EdgeFalling(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=EdgeFalling, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EdgeFalling_1, CY_INSTANCE_SHORT_NAME=EdgeFalling_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=EdgeFalling_1, )
module EdgeFalling_20 (
    d,
    clk,
    det);
    input       d;
...
// EdgeRising(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=EdgeRising, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EdgeRising_1, CY_INSTANCE_SHORT_NAME=EdgeRising_1, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=EdgeRising_1, )
module EdgeRising_21 (
    d,
    clk,
    det);
    input       d;
...
module top ;
    ...
    UART_v2_50_6 UART (
        ...
        .reset(1'b0),
        .rx(Net_542),
        .tx_interrupt(Net_961),
        .rx_interrupt(Net_962),
        .tx_data(Net_963),
        .tx_clk(Net_964),
        .rx_data(Net_965),
        .rx_clk(Net_966));
    ...
    assign Net_765 = Net_676 & Net_797 & Net_795 & Net_757 & h3 & Net_801 & Net_802 & Net_803;
    ...
    CyStatusReg_v1_90 SREG_RX_SLOT (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_1279),
        .status_bus(rx_slot_cnt[3:0]));
    defparam SREG_RX_SLOT.Bit0Mode = 0;
    defparam SREG_RX_SLOT.Bit1Mode = 0;
    defparam SREG_RX_SLOT.Bit2Mode = 0;
    defparam SREG_RX_SLOT.Bit3Mode = 0;
    defparam SREG_RX_SLOT.Bit4Mode = 0;
    defparam SREG_RX_SLOT.Bit5Mode = 0;
    defparam SREG_RX_SLOT.Bit6Mode = 0;
    defparam SREG_RX_SLOT.Bit7Mode = 0;
    defparam SREG_RX_SLOT.BusDisplay = 1;
    defparam SREG_RX_SLOT.Interrupt = 0;
    defparam SREG_RX_SLOT.MaskValue = 0;
    defparam SREG_RX_SLOT.NumInputs = 4;

    assign Net_1157[2:0] = 3'h7;
    ...
    assign Net_1170 = Net_1186 & dma_th_trig;
	...
	wire [0:0] tmpOE__TH_SLOW_OUT_net;
	wire [0:0] tmpFB_0__TH_SLOW_OUT_net;
	wire [0:0] tmpIO_0__TH_SLOW_OUT_net;
	wire [0:0] tmpINTERRUPT_0__TH_SLOW_OUT_net;
	electrical [0:0] tmpSIOVREF__TH_SLOW_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		TH_SLOW_OUT
		 (.oe(tmpOE__TH_SLOW_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TH_SLOW_OUT_net[0:0]}),
		  .analog({Net_893}),
		  .io({tmpIO_0__TH_SLOW_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__TH_SLOW_OUT_net),
		  .interrupt({tmpINTERRUPT_0__TH_SLOW_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TH_SLOW_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TH_FAST_OUT_net;
	wire [0:0] tmpFB_0__TH_FAST_OUT_net;
	wire [0:0] tmpIO_0__TH_FAST_OUT_net;
	wire [0:0] tmpINTERRUPT_0__TH_FAST_OUT_net;
	electrical [0:0] tmpSIOVREF__TH_FAST_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d49052a1-abcf-496d-89b0-66851286d2e2"),
		  ...
		  .input_buffer_sel(2'b00))
		TH_FAST_OUT
		 (.oe(tmpOE__TH_FAST_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TH_FAST_OUT_net[0:0]}),
		  .analog({Net_897}),
		  .io({tmpIO_0__TH_FAST_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__TH_FAST_OUT_net),
		  .interrupt({tmpINTERRUPT_0__TH_FAST_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TH_FAST_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TH_SLOW_IN_net;
	wire [0:0] tmpFB_0__TH_SLOW_IN_net;
	wire [0:0] tmpIO_0__TH_SLOW_IN_net;
	wire [0:0] tmpINTERRUPT_0__TH_SLOW_IN_net;
	electrical [0:0] tmpSIOVREF__TH_SLOW_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8bf766a8-88f1-40c4-8f54-cd5001c5987a"),
		  ...
		  .input_buffer_sel(2'b00))
		TH_SLOW_IN
		 (.oe(tmpOE__TH_SLOW_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TH_SLOW_IN_net[0:0]}),
		  .analog({Net_887}),
		  .io({tmpIO_0__TH_SLOW_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__TH_SLOW_IN_net),
		  .interrupt({tmpINTERRUPT_0__TH_SLOW_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TH_SLOW_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TH_FAST_IN_net;
	wire [0:0] tmpFB_0__TH_FAST_IN_net;
	wire [0:0] tmpIO_0__TH_FAST_IN_net;
	wire [0:0] tmpINTERRUPT_0__TH_FAST_IN_net;
	electrical [0:0] tmpSIOVREF__TH_FAST_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("32cbcf25-d3bd-4efd-9daf-6ccb421b8976"),
		  ...
		  .input_buffer_sel(2'b00))
		TH_FAST_IN
		 (.oe(tmpOE__TH_FAST_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TH_FAST_IN_net[0:0]}),
		  .analog({Net_891}),
		  .io({tmpIO_0__TH_FAST_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__TH_FAST_IN_net),
		  .interrupt({tmpINTERRUPT_0__TH_FAST_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TH_FAST_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_904 = Net_901 & th_en & Net_902;
	...
	cy_isr_v1_0
		#(.int_type(2'b00))
		ISR_ADC_RX
		 (.int_signal(dma_rx_res));



    assign Net_976 = rx_en & rx_slot0_p & rx_slot1_p & rx_slot2_p;

    assign Net_952 = 1'h1;


    assign adc_soc = Net_977 | Net_976;

    // -- SRFF Start --
    reg  cy_srff_6;
    always @(posedge clk_bus)
    begin
        cy_srff_6 <= (Net_976 | dma_rx_trig) & ~dma_rx_res;
    end
    assign dma_rx_trig = cy_srff_6;
    // -- SRFF End --


    assign Net_977 = rx_slot0_p & th_en;


    assign Net_1005 = dma_rx_trig & Net_1186;

    // -- SRFF Start --
    reg  cy_srff_7;
    always @(posedge clk_bus)
    begin
        cy_srff_7 <= (Net_977 | dma_th_trig) & ~dma_rx_res;
    end
    assign dma_th_trig = cy_srff_7;
    // -- SRFF End --
    ...
    assign Net_1163 = Net_1160 & pre_detect;

    CyControlReg_v1_80 CREG_RX_SLOT_OFFS (
        .control_1(Net_1258),
        .control_2(Net_1259),
        .control_3(Net_1260),
        .control_0(Net_1261),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_1087[3:0]));
    defparam CREG_RX_SLOT_OFFS.Bit0Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit1Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit2Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit3Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit4Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit5Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit6Mode = 0;
    defparam CREG_RX_SLOT_OFFS.Bit7Mode = 0;
    defparam CREG_RX_SLOT_OFFS.BitValue = 0;
    defparam CREG_RX_SLOT_OFFS.BusDisplay = 1;
    defparam CREG_RX_SLOT_OFFS.ExtrReset = 0;
    defparam CREG_RX_SLOT_OFFS.NumOutputs = 4;

    EdgeRising_16 EdgeRising_6 (
        .d(rx_slot1),
        .clk(clk_edge),
        .det(rx_slot1_p));

    EdgeRising_17 EdgeRising_5 (
        .d(rx_slot0),
        .clk(clk_edge),
        .det(rx_slot0_p));

    assign Net_1256 = 1'h1;

    // -- LUT LUT_RX_SLOTS start --
    if (1)
    begin : LUT_RX_SLOTS
        reg [7:0] tmp__LUT_RX_SLOTS_reg;
        wire [2:0] tmp__LUT_RX_SLOTS_ins;
        assign tmp__LUT_RX_SLOTS_ins = {Net_1128[2],Net_1128[1],Net_1128[0]};
        always @(tmp__LUT_RX_SLOTS_ins)
        begin
            case (tmp__LUT_RX_SLOTS_ins)
                3'b000 :  tmp__LUT_RX_SLOTS_reg = 8'b00000001;
                3'b001 :  tmp__LUT_RX_SLOTS_reg = 8'b00000010;
                3'b010 :  tmp__LUT_RX_SLOTS_reg = 8'b00000100;
                3'b011 :  tmp__LUT_RX_SLOTS_reg = 8'b00001000;
                3'b100 :  tmp__LUT_RX_SLOTS_reg = 8'b00010000;
                3'b101 :  tmp__LUT_RX_SLOTS_reg = 8'b00100000;
                3'b110 :  tmp__LUT_RX_SLOTS_reg = 8'b01000000;
                3'b111 :  tmp__LUT_RX_SLOTS_reg = 8'b10000000;
            endcase
        end
        assign {rx_slot7,rx_slot6,rx_slot5,rx_slot4,rx_slot3,rx_slot2,rx_slot1,rx_slot0} = tmp__LUT_RX_SLOTS_reg;
    end
    // -- LUT LUT_RX_SLOTS end --

    assign Net_1069 = (rx_slot_cnt[3:0] == Net_1087[3:0]);

    PerCounter3bit_18 CNT_RX_SLOTS (
        .en(Net_1256),
        .reset(Net_1069),
        .clk(clk_rx_slots),
        .cmp_val(Net_1157[2:0]),
        .cnt(Net_1128[2:0]),
        .cmp(Net_1257));
	...
	wire [0:0] tmpOE__INPUT_ADC_net;
	wire [0:0] tmpFB_0__INPUT_ADC_net;
	wire [0:0] tmpIO_0__INPUT_ADC_net;
	wire [0:0] tmpINTERRUPT_0__INPUT_ADC_net;
	electrical [0:0] tmpSIOVREF__INPUT_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("f274132d-cb06-4aeb-9f83-cd31a79ef076"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		INPUT_ADC
		 (.oe(tmpOE__INPUT_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INPUT_ADC_net[0:0]}),
		  .analog({adc_in}),
		  .io({tmpIO_0__INPUT_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__INPUT_ADC_net),
		  .interrupt({tmpINTERRUPT_0__INPUT_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INPUT_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign rx_en = 1'h1;

    assign pre_en = 1'h0;

    CyControlReg_v1_80 CREG_RX_EN (
        .control_1(Net_1214),
        .control_2(Net_1215),
        .control_3(Net_1216),
        .control_0(Net_1160),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam CREG_RX_EN.Bit0Mode = 0;
    defparam CREG_RX_EN.Bit1Mode = 0;
    defparam CREG_RX_EN.Bit2Mode = 0;
    defparam CREG_RX_EN.Bit3Mode = 0;
    defparam CREG_RX_EN.Bit4Mode = 0;
    defparam CREG_RX_EN.Bit5Mode = 0;
    defparam CREG_RX_EN.Bit6Mode = 0;
    defparam CREG_RX_EN.Bit7Mode = 0;
    defparam CREG_RX_EN.BitValue = 0;
    defparam CREG_RX_EN.BusDisplay = 0;
    defparam CREG_RX_EN.ExtrReset = 0;
    defparam CREG_RX_EN.NumOutputs = 1;


    assign cmp_out = rx_en & Net_901;

    CyControlReg_v1_80 CREG_TH_EN (
        .control_1(Net_1231),
        .control_2(Net_1232),
        .control_3(Net_1233),
        .control_0(th_en),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam CREG_TH_EN.Bit0Mode = 0;
    defparam CREG_TH_EN.Bit1Mode = 0;
    defparam CREG_TH_EN.Bit2Mode = 0;
    defparam CREG_TH_EN.Bit3Mode = 0;
    defparam CREG_TH_EN.Bit4Mode = 0;
    defparam CREG_TH_EN.Bit5Mode = 0;
    defparam CREG_TH_EN.Bit6Mode = 0;
    defparam CREG_TH_EN.Bit7Mode = 0;
    defparam CREG_TH_EN.BitValue = 0;
    defparam CREG_TH_EN.BusDisplay = 0;
    defparam CREG_TH_EN.ExtrReset = 0;
    defparam CREG_TH_EN.NumOutputs = 1;

    EdgeFalling_20 EdgeFalling_1 (
        .d(cmp_out),
        .clk(clk_edge),
        .det(Net_1254));


    assign pre_falling = pre_en & Net_1254;

    EdgeRising_21 EdgeRising_1 (
        .d(cmp_out),
        .clk(clk_edge),
        .det(Net_1251));


    assign pre_rising = Net_1251 & pre_en;
    ...
    assign Net_1280 = 1'h1;

    assign Net_1282 = 1'h0;

    // -- DFF Start --
    reg  cydff_34;
    always @(posedge pre_rising)
    begin
        cydff_34 <= rx_slot_cnt[2];
    end
    assign Net_1290 = cydff_34;
    // -- DFF End --

    CyStatusReg_v1_90 SREG_PRE_RISING (
        .status_0(Net_1293),
        .status_1(Net_1294),
        .status_2(Net_1290),
        .status_3(1'b0),
        ...
        .intr(Net_1302),
        .status_bus(8'b0));
    defparam SREG_PRE_RISING.Bit0Mode = 0;
    defparam SREG_PRE_RISING.Bit1Mode = 0;
    defparam SREG_PRE_RISING.Bit2Mode = 0;
    defparam SREG_PRE_RISING.Bit3Mode = 0;
    defparam SREG_PRE_RISING.Bit4Mode = 0;
    defparam SREG_PRE_RISING.Bit5Mode = 0;
    defparam SREG_PRE_RISING.Bit6Mode = 0;
    defparam SREG_PRE_RISING.Bit7Mode = 0;
    defparam SREG_PRE_RISING.BusDisplay = 0;
    defparam SREG_PRE_RISING.Interrupt = 0;
    defparam SREG_PRE_RISING.MaskValue = 0;
    defparam SREG_PRE_RISING.NumInputs = 3;

    // -- DFF Start --
    reg  cydff_35;
    always @(posedge pre_rising)
    begin
        cydff_35 <= rx_slot_cnt[1];
    end
    assign Net_1294 = cydff_35;
    // -- DFF End --
    ...
    always @(posedge pre_rising)
    begin
        cydff_36 <= rx_slot_cnt[0];
    end
    assign Net_1293 = cydff_36;
    // -- DFF End --

    // -- DFF Start --
    reg  cydff_37;
    always @(posedge pre_falling)
    begin
        cydff_37 <= rx_slot_cnt[2];
    end
    assign Net_1313 = cydff_37;
    // -- DFF End --

    CyStatusReg_v1_90 SREG_PRE_FALLING (
        .status_0(Net_1314),
        .status_1(Net_1315),
        .status_2(Net_1313),
        .status_3(1'b0),
        ...
        .intr(Net_1321),
        .status_bus(8'b0));
    defparam SREG_PRE_FALLING.Bit0Mode = 0;
    defparam SREG_PRE_FALLING.Bit1Mode = 0;
    defparam SREG_PRE_FALLING.Bit2Mode = 0;
    defparam SREG_PRE_FALLING.Bit3Mode = 0;
    defparam SREG_PRE_FALLING.Bit4Mode = 0;
    defparam SREG_PRE_FALLING.Bit5Mode = 0;
    defparam SREG_PRE_FALLING.Bit6Mode = 0;
    defparam SREG_PRE_FALLING.Bit7Mode = 0;
    defparam SREG_PRE_FALLING.BusDisplay = 0;
    defparam SREG_PRE_FALLING.Interrupt = 0;
    defparam SREG_PRE_FALLING.MaskValue = 0;
    defparam SREG_PRE_FALLING.NumInputs = 3;

    // -- DFF Start --
    reg  cydff_38;
    always @(posedge pre_falling)
    begin
        cydff_38 <= rx_slot_cnt[1];
    end
    assign Net_1315 = cydff_38;
    // -- DFF End --
    ...
    always @(posedge pre_falling)
    begin
        cydff_39 <= rx_slot_cnt[0];
    end
    assign Net_1314 = cydff_39;
    // -- DFF End --
